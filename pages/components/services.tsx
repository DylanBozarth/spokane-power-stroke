...
<div className="flex flex-wrap -mx-1 lg:-mx-4 text-center ">
    ...
    <p className={active  === 1 ? 'text-center' : 'hidden'}>Additional information about powerstrokes</p>
    <p className={active  === 2 ? 'text-center' : 'hidden'}>Additional information about Gas engines</p>
    <p className={active  === 3 ? 'text-center' : 'hidden'}>Additional information about Steering systems</p>
    <p className={active  === 4 ? 'text-center' : 'hidden'}>Additional information about Differentials</p>
    <p className={active  === 5 ? 'text-center' : 'hidden'}>Additional information about Diesel engines</p>
    <p className={active  === 6 ? 'text-center' : 'hidden'}>Additional information about Brakes</p>
    <div className="flex  ">
