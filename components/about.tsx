...
export const About = (props: any) => {
    return (
      ...
      Brandon Bozarth
      <Image src={Brandon}  alt="mechanic" /><h3>Ford Cerfitied master Technician
      {/* view cerfitication */}</h3></div>
      
      <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
      Alvin Finch
      <Image src={Alvin}  alt="mechanic" /><h3 id="reviews">Ford Cerfitied master Technician</h3 ></div>
      <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
      Dustin Andersen
      <Image src={Dustin}  alt="mechanic" /><h3>Ford Cerfitied master Technician</h3 ></div>
    </div>
    )
}
