...
export const About = (props: any) => {
    return (
      ...
      Brandon Bozarth
      <Image src={Brandon}  alt="mechanic" priority={true} /><h3>Ford certified master Technician
      {/* view cerfitication */}</h3></div>
      
      <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
      Alvin Finch
      <Image src={Alvin}  alt="mechanic"  priority={true}  /><h3 id="reviews">Ford certified master Technician</h3 ></div>
      <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
      Dustin Andersen
      <Image src={Dustin}  alt="mechanic"   priority={true} /><h3>Ford certified master Technician</h3 ></div>
    </div>
    )
}
